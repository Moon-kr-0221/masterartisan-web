  ...
  return (
    <>
      ...
      <section className="md:hidden" style={{ backgroundColor: '#F0EDE6' }}>
        {[
          { img: 'https://images.unsplash.com/photo-1771411068495-11575ea96c51?auto=format&fit=crop&w=1080&q=80', title: '다릅니다', sub: '남들과 다른 길을 걷습니다' },
          { img: 'https://images.unsplash.com/photo-1655645888733-f0c9f8827a49?auto=format&fit=crop&w=1080&q=80', title: '바릅니다', sub: '원칙을 바르게 지킵니다' },
        ].map((item) => (
          <article key={item.title} className="relative overflow-hidden" style={{ height: 320, backgroundColor: '#0E0D0B' }}>
            ...
            <div className="absolute" style={{ bottom: 28, left: 24 }}>
              ...
              <p style={{ fontFamily: SANS, fontSize: 13, color: 'rgba(255,255,255,0.7)', marginTop: 8 }}>{item.sub}</p>
            </div>
          </article>
        ))}
      </section>
