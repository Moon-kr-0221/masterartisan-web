  ...
  return (
    <section ref={ref} className="flex flex-col md:flex-row w-full overflow-hidden">
      ...
      <motion.div
        ...
        style={{ backgroundColor: '#0E0D0B', minHeight: 'clamp(360px, 50vw, 700px)' }}
      ...
      >
        ...
        <div className="absolute z-10 bottom-[40px] left-[28px] md:bottom-[45px] md:left-[52px]">
          <motion.span
          ...
          <motion.p
            ...
            style={{ fontFamily: 'var(--font-serif)', fontSize: 'clamp(40px, 5vw, 60px)', letterSpacing: '-0.033em', color: '#FFFFFF', lineHeight: 1.43 }}
          >
            다릅니다
          </motion.p>
          <motion.p
            ...
            className="mt-4 text-[13px] leading-[1.85] max-w-[380px] md:max-w-[520px]"
      ...
      <motion.div
        className="relative flex-1 overflow-hidden"
        style={{ backgroundColor: '#F0EDE6', minHeight: 'clamp(360px, 50vw, 700px)' }}
        initial={{ opacity: 0, x: 40 }}
        whileInView={{ opacity: 1, x: 0 }}
        transition={{ duration: 1, ease: EASE }}
        viewport={{ once: true, margin: '-60px' }}
      >
        ...
        <div className="absolute z-10 text-right bottom-[40px] right-[28px] md:bottom-[45px] md:right-[60px]">
          <motion.span
            initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}
            transition={{ duration: 0.8, delay: 0.2 }} viewport={{ once: true }}
          ...
          <motion.p
            initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.3 }} viewport={{ once: true }}
            className="mt-4 text-sm leading-[1.85] ml-auto max-w-[280px] md:max-w-[320px]"
