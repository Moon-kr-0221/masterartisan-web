...
export default async function MasterArtisanPage() {
  ...
  return (
    <div style={{ backgroundColor: '#FFFFFF', paddingTop: 72, overflowX: 'hidden' }}>
      ...
      <section style={{ position: 'relative', height: 360, overflow: 'hidden' }}>
        ...
        <div
          ...
          style={{ background: 'linear-gradient(0deg, rgba(0,0,0,0.65) 0%, rgba(0,0,0,0.25) 50%, rgba(0,0,0,0.05) 100%)' }}
        />
        {/* 모바일: 하단 정렬 */}
        <div className="absolute inset-0 flex flex-col justify-end gap-3 p-6 md:hidden">
          ...
          <h1 style={{ fontFamily: SERIF, fontSize: 32, fontWeight: 300, lineHeight: 1.2, color: '#FFFFFF' }}>장인을 소개합니다</h1>
          <p style={{ fontFamily: SANS, fontSize: 13, lineHeight: 1.8, color: 'rgba(255,255,255,0.65)' }}>1936년부터 3대에 걸쳐 전통건축의 혼을 이어온 장인들을 소개합니다.</p>
        </div>
        {/* 데스크탑: d933990 고정 좌표 */}
        <div
          className="hidden md:flex md:flex-col md:absolute"
          style={{ left: 80, top: 152, gap: 10 }}
        >
          <span style={{ fontFamily: SANS, fontSize: 11, letterSpacing: '4px', color: 'rgba(255,255,255,0.6)' }}>THE ARTISANS</span>
          ...
          <section key={artisan.generation} style={{ backgroundColor: bg }}>
            <div className={`flex flex-col ${reversed ? 'md:flex-row-reverse' : 'md:flex-row'}`}>
              ...
              <div
                ...
                style={{ height: 'clamp(260px, 40vw, 520px)', backgroundColor: '#EDEAE4' }}
              >
              ...
              <ScrollReveal
                ...
                className="flex-1 flex flex-col px-6 py-10 md:px-[80px] md:py-[72px]"
              >
